  ...
  return (
    <>
      <section className="bg-[#fbf7ee]">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-[1.4fr_0.9fr] lg:px-8 lg:py-20">
          <div className="flex flex-col justify-center">
            ...
            <h1 className="mt-6 max-w-3xl text-4xl font-semibold leading-tight text-medical-navy sm:text-5xl lg:text-6xl">
          ...
          <div className="rounded-2xl bg-[#C8DDD4] p-6 shadow-soft">
            <div className="flex min-h-[200px] flex-col items-center justify-center rounded-xl bg-white/30 text-center md:min-h-[280px]">
      ...
      <section className="bg-[#1B6B4A] px-4 py-4 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl grid-cols-3 divide-x divide-white/15 text-center">
          {[
      ...
      <section id="formations" className="bg-white px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section className="bg-[#fbf7ee] px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-4xl gap-5 rounded-2xl bg-white p-6 shadow-soft sm:grid-cols-[80px_1fr] sm:p-8">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-medical-navy">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {testimonials.map((testimonial) => (
              <article key={testimonial.author} className="rounded-lg bg-[#fbf7ee] p-4">
      ...
      <section className="bg-[#fbf7ee] px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl rounded-2xl bg-white p-6 shadow-soft sm:p-8">
          <h2 className="text-3xl font-semibold text-medical-navy">Questions fréquentes</h2>
          <div className="mt-6">
            {faqItems.map((item) => (
